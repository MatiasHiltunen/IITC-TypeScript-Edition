...
export const getMapZoomTileParameters = (zoom): ZoomTileParameters => {
...
export const getDataZoomTileParameters = (zoom?) => {
...
export const getDataZoomForMapZoom = (zoom) => {
